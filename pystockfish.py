...
# My fork of the pystockfish library. It adds
# time management features for stockfish.

# My patch may be added to the main library, I 
# have submitted a request for it:
# https://github.com/iamjarret/pystockfish/pull/23/commits/f4eb0c3e26fbcbf3b5a84825480285200827d464

# My original fork of the repository with the feature:
# https://github.com/applemonkey496/pystockfish/blob/patch-1/pystockfish.py
